...
/*This class used for the making the game logic fo the cell movements  */
public class Game {
  ...
  private static final long MOVE_ANIMATION_TIME = View.BASE_ANIMATION_TIME;
  private static final long SPAWN_ANIMATION_TIME = View.BASE_ANIMATION_TIME;
  private static final long NOTIFICATION_DELAY_TIME = MOVE_ANIMATION_TIME + SPAWN_ANIMATION_TIME;
  private static final long NOTIFICATION_ANIMATION_TIME = View.BASE_ANIMATION_TIME * 5;
